...
public class Filehandling {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter content to write in the file: ");
		...
		System.out.print("Enter new word to replace old word: ");
		String newWord = scanner.nextLine();

		if (!modifyFile(fileName, targetWord, newWord)) {
			System.out.println("Word to replace was not found in the file.");
		}
		readFile(fileName);
